    ...
    return (
        <div className="w-screen h-screen p-0 m-0 flex items-center justify-center">
            ...
            <p className="text-9xl font-bold">404</p>
                ...
                <Link to="/" className="px-1 py-2 bg-blue-600 text-center rounded text-white font-bold shadow-md duration-[0.3s] hover:bg-white hover:text-blue-600 hover:duration-[0.3s] hover:scale-[0.98]">Voltar para a página inicial</Link>
            </div>
        </div>
